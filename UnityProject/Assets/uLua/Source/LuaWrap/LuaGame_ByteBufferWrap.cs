...
public class LuaGame_ByteBufferWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateLuaGame_ByteBuffer),
		...
		LuaScriptMgr.RegisterLib(L, "LuaGame.ByteBuffer", typeof(LuaGame.ByteBuffer), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateLuaGame_ByteBuffer(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			LuaGame.ByteBuffer obj = new LuaGame.ByteBuffer();
		...
		else if (count == 1)
		{
			...
			LuaGame.ByteBuffer obj = new LuaGame.ByteBuffer(objs0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: LuaGame.ByteBuffer.New");
		}

		return 0;
	}

	static Type classType = typeof(LuaGame.ByteBuffer);
	...
	static int get_isNil(IntPtr L)
	{
		...
		LuaGame.ByteBuffer obj = (LuaGame.ByteBuffer)o;
	...
	static int Close(IntPtr L)
	{
		...
		LuaGame.ByteBuffer obj = (LuaGame.ByteBuffer)LuaScriptMgr.GetNetObjectSelf(L, 1, "LuaGame.ByteBuffer");
		obj.Close();
		return 0;
	}
