...
public class LuaScriptMgr
{
    ...
    static public string LuaBasePath
    {
        get { return BasePath; }
        set { BasePath = value; }
    }
    ...
    static public string LuaConfigPath
    {
    ...
    public byte[] Loader(string name)
    {
...
#if !LUA_ZIP
        string path = Path.Combine(LuaBasePath, name);
        ...
        if (File.Exists(path))
        {
            ...
            Debugger.LogWarning(string.Format("Loader:can not open file:{0}", path));
#else
    ...
    public byte[] LuaDoFile(string name)
    {
        byte[] str = null;
        string path = Path.Combine(LuaConfigPath, name);
        ...
        if (File.Exists(path))
        {
            ...
            Debugger.LogWarning(string.Format("DoFile:can not open file:{0}", path));
