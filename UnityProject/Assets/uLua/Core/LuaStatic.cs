namespace LuaInterface
{
    ...
    public delegate byte[] LuaLoadFileDelegate(string name);
    public delegate byte[] LuaDoFileDelegate(string name);
	
	public static class LuaStatic
	{
        public static LuaLoadFileDelegate Load = null;
        public static LuaDoFileDelegate LuaDoFile = null;
        //private static int trace = 0;

        static LuaStatic()
        {
            Load = DefaultLoader;
            LuaDoFile = DefaultDoFile;
        }
        ...
        static byte[] DefaultDoFile(string path)
        {
            byte[] str = null;
		...
		{            
			...
			// Load with Unity3D resources			
            byte[] text = LuaStatic.LuaDoFile(fileName);
